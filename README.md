  ...
  <body onload="startTime()">
    ...
    <div class="main">
      <div class="content">
        ...
        <div class="btn-mulai">
          <p class="hilang1" onclick="notif1()">Klik ini caa</p>
